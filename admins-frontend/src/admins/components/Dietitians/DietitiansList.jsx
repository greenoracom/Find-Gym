...
const DietitiansList = () => {
  ...
  const dietitians = [
    { id: 'DT-301', name: 'Dr. Ritu Sharma', email: 'ritu@example.com', spec: 'Weight Loss, Keto', status: 'Verified', clients: 45 },
    { id: 'DT-302', name: 'Pooja Hegde', email: 'pooja@example.com', spec: 'Sports Nutrition', status: 'Pending', clients: 12 },
  ];
  ...
  return (
    <div className="animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Dietitians</h1>
          <p className="text-sm text-gray-500">Manage dietitians and verify qualifications</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <Table data={dietitians} columns={columns} />
      </div>
    </div>
  );
};
